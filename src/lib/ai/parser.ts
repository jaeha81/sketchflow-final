...
const analysisSchema = z.object({
  spatial_summary: z.object({
    ...
    text_ko: z.string().default(''),
    zones: z.array(z.object({
      id: z.string().default(() => `z_${Math.random().toString(36).slice(2,6)}`),
    ...
    elements: z.array(z.object({
      id: z.string().default(() => `el_${Math.random().toString(36).slice(2,6)}`),
  ...
  }).default({ text: '', text_ko: '', zones: [], elements: [], overall_confidence: 'low' }),
  ...
  estimate_items: z.object({
    items: z.array(z.object({
      ...
      name_ko: z.string().default(''),
      unit: z.string().default('LOT'),
      estimated_quantity: z.number().nullable().default(null),
      note: z.string().default(''),
    })).default([]),
  }).default({ items: [] }),
  ...
  }).default({ text: '', text_ko: '', confirmed_items: [], pending_items: [] }),
